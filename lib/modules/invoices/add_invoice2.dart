...
class AddInvoice2 extends StatefulWidget {
  ...
  AddInvoice2({super.key, required this.invoices});

  @override
  State<AddInvoice2> createState() => _AddInvoice2State();
}

class _AddInvoice2State extends State<AddInvoice2> {
  bool check1 = false;
  bool check2 = false;
  String firstInvoiceSending = "Due date";
  List<String> invoiceSendings = <String>[
    "Due date",
    "Before Due date by 1 Day",
    "Before Due date by 2 Day",
    "Before Due date by 3 Day",
    "Before Due date by 4 Day",
    "Before Due date by 5 Day"
  ];
  String firstRecuringType = "Daily";
  List<String> recuringType = <String>[
    "Daily",
    "Weekly",
    "Biweekly",
    "Monthly"
            ...
            Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsets.only(right: 30.w, left: 30.w, top: 20.h),
                    child: InputDecorator(
                      decoration: InputDecoration(
                        labelText: 'Recuring Type',
                        border: OutlineInputBorder(
                      ...
                      child: ButtonTheme(
                        ...
                        child: DropdownButton<String>(
                          hint: const Text("Recuring Type"),
                          isExpanded: true,
                          value: firstRecuringType,
                          elevation: 16,
                  ...
                  Padding(
                    padding:
                        EdgeInsets.only(right: 30.w, left: 30.w, top: 15.h),
                    child: InputDecorator(
                      decoration: InputDecoration(
                        labelText: 'Invoice Sending',
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(5.0.r)),
                        contentPadding: EdgeInsets.all(5.r),
                      ),
                      child: ButtonTheme(
                        materialTapTargetSize: MaterialTapTargetSize.padded,
                        child: DropdownButton<String>(
                          hint: const Text("Invoice Sending"),
                          isExpanded: true,
                          value: firstInvoiceSending,
                          elevation: 16,
                          underline: DropdownButtonHideUnderline(
                            child: Container(),
                          ),
                          onChanged: (String? newValue) {
                            setState(() {
                              firstInvoiceSending = newValue!;
                            });
                          },
                          items: invoiceSendings
                              .map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
