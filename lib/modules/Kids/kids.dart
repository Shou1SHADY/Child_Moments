...
import 'package:child_moments/modules/Kids/add_parent.dart';
import 'package:child_moments/modules/Kids/edit_kid.dart';
import 'package:child_moments/modules/Kids/kid_search.dart';
import 'package:child_moments/modules/Kids/preview.dart';
                  ...
                  child: TextButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (_) => const AddKid()));
                      },
                      child: const Text(
                        "+ Add new Kid",
                        style: TextStyle(color: Colors.white),
